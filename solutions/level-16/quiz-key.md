...
- **A. Acting on information you did not have yet** ✅
- B. Trading on the last day of the sample
- C. Costs being double counted
- D. Division by zero in the returns
...
- A. A very strong strategy
- **B. Lookahead bias** ✅
- C. Too little data
- D. Costs were set too low
...
- **B. Because it is a single number a reader can judge against reality, instead of an assumption to argue about** ✅
- C. Because regulators require it
- D. Because it is always lower
...
- **B. Testing on names that lasted, because the failures were removed from the data** ✅
- C. Overweighting recent data
- D. Ignoring dividends
...
- B. The parameters need finer steps
- **C. The best in sample result was mostly luck, and searching harder makes that more certain** ✅
...
- A. What is the idea, who else uses it, and how much capital it takes
- **B. How many variations were tried, what happened on untouched data, and what the turnover and cost are** ✅
- C. Which library, which data vendor, and which language
- D. The maximum drawdown, the hit rate and the time in market
...
- B. The fits, because they use more data
...
- A. The market is changing quickly
- B. The fit window is too long
- C. The optimiser has a bug
- **D. There is probably nothing to choose, and the parameter is noise** ✅
...
- **A. Its time in market, so the comparison is fair** ✅
- B. Nothing extra, Sharpe already accounts for it
- C. The number of trades only
- D. That it is riskier by definition
...
- B. Because it determines the tax treatment
...
- A. Fine, the date is in the past
- **B. Lookahead, because earnings are published weeks after the quarter they describe** ✅
- C. Survivorship bias
- D. Only a problem for daily strategies
...
- **D. How many variations were tried in total, including abandoned ones** ✅
...
- C. Rolling uses all history every time
- D. Rolling cannot be used with daily data
...
- **A. Both, with a sentence explaining why they differ** ✅
- B. The single split, since it used more data for fitting
- C. The walk forward only
- D. Whichever is closer to the benchmark
